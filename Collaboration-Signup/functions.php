...
if(isset($_REQUEST['method']))
{
	...
	switch($method)
	{
		...
		case 'new_register':
			...
			if($fn=='' || $ln=='' || $loc=='' || $wp_email=='' || $aff=='' || $email1=='' || $email2=='' || $pass1=='' || $pass2=='')
			{
			...
			else
			{
				...
				// Insert a record
				$add_user->insert($email1, array('aff' => $aff, 'created_by' => $wp_email, 'created_on' => $created_on, 'first_name' => $fn, 'last_name' => $ln, 'location' => $loc, 'password' => $pass1, 'ip' => $ip, 'script_progress' => 0, 'shots_count' => 0, 'status' => $status, 'videos_count' => 0, 'url_yt' => '', 'url_gplus' => '', 'updated_on' => $created_on, 'website' => $website));
